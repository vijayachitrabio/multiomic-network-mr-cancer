...
# ══════════════════════════════════════════════════════════════════════════════
# SLIDE 11 — [REDACTED] REPLICATION
# ══════════════════════════════════════════════════════════════════════════════
s = prs.slides.add_slide(BLANK)
add_rect(s, 0, 0, W, H, fill_rgb=WHITE)
title_bar(s, "[REDACTED] pQTL Validation Attempt",
...
# comparison table
comp = [
    ("Metric",         "FinnGen (N=619)",  "[REDACTED] (N=33,995)"),
...
print("✓ Slide 11: [REDACTED] Replication")
...
s = prs.slides.add_slide(BLANK)
add_rect(s, 0, 0, W, H, fill_rgb=WHITE)
title_bar(s, "Observational Triangulation in [REDACTED]",
...
add_bullet_box(s,
    ["10 / 17 MR-predicted directions supported observationally",
     ...
     (1, "[REDACTED] includes incident + prevalent cases"),
...
tiers = [
    ...
    (GREY,     "TIER 4",  "Suggestive",
     ...
     "Single-SNP Wald ratio only  |  Require deCODE/[REDACTED] replication"),
]
...
msgs = [
    ...
    (ORANGE,   "4",
     "[REDACTED] confirms instrument quality for APOE",
